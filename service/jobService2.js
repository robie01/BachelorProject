...
app2.get('/service2/jobs',(req, res) => {
                ...
                fetch(api_url)
                    ...
                    .then(jobs => {
                        ...
                        jobs.forEach(function (job) {
                            ...
                            jobContent_api2.push(sortedValue)
                            console.log(jobContent_api2)
                        })

                        // Save the  API response in Redis store,  data expire time in 18000 seconds, it means 30 mins
                        client.setex(jobList2RedisKey, 1800, JSON.stringify(jobContent_api2))

                        console.log("result", jobContent_api2)
                        // Send JSON response to client
                        return res.json({source: 'api', fields: jobContent_api2})
